...
public class SearchAdapter extends BaseAdapter implements Filterable {
    ...
    private ArrayList<Map<String, StudyGroup>> filterStudyList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(filterStudyList.size() > position) {
            Map<String, StudyGroup> studyGroupMap = filterStudyList.get(position);
    ...
    private class ListFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if(constraint == null || constraint.length() == 0) {
                ...
                ArrayList<Map<String, StudyGroup>> itemList = new ArrayList<Map<String, StudyGroup>>();

                for(Map<String, StudyGroup> item: studyList) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filterStudyList = (ArrayList<Map<String, StudyGroup>>) results.values;
            if(results.count > 0) {
